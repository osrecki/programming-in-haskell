...
-- | 1.1
--   Define function that concatenates three strings, but drops the middle
--   one if it's shorter than 2 characters (use 'length' function).
...
-- | 1.2.2
--   Additionally check that salary is non-negative. If it's negative,
--   return an adequate message.
