...
Description : Solutions to in-class exercises for Lecture 6
...
-- | 1.2 a
--   Write an accumulator-style recursive definition of a function
--   which returns the maximum element at the first position and
--   the maximum element at the second position in a pair.
